package com.sweetjuice.pkg.daemon;
 ...
 */
public class DaemonPlugin implements SweetJuicePlugin {
    ...
    private String start(String jsonArgs) throws JSONException {
        ...
        Intent intent = new Intent(mContext, SweetJuiceDaemonService.class);
        intent.setAction(SweetJuiceDaemonService.ACTION_START);
    ...
    private String stop() {
        Intent intent = new Intent(mContext, SweetJuiceDaemonService.class);
        intent.setAction(SweetJuiceDaemonService.ACTION_STOP);
        mContext.startService(intent);
